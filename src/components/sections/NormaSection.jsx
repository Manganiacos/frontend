...
import Norma from '../../assets/svg/logos/norma';
...
function NormaSection() {
  ...
  const productsFilter = products
    .filter((product) => product.editorial === 'norma')
    .map((product) => {
  ...
  return (
    <>
      <section className="relative flex flex-col bg-black/30 rounded-lg shadow-md">
        <div className="bg-[#F8F400] p-14 rounded-t-lg absolute w-full"></div>
