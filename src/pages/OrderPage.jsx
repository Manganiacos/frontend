                  ...
                  {order.paymentMethod === 'whatsapp' && (
                    <>
                      <h1 className="text-sm text-white">
                        Contacta con nosotros por whatsapp para realizar el
                        pago.
                      </h1>
                      <hr className="border-white/20 my-5" />
                    </>
                      ...
                      <div className="flex flex-col gap-2">
                        <span className="flex flex-row gap-1 items-center">
                          ...
                          <h1 className="text-white/80 text-xs">
                            Por favor, envianos el comprobante de pago lo mas
                            rapido posible.
                          </h1>
                        </span>
                        <span className="flex flex-row gap-1 items-center">
              ...
              <span className="flex flex-col gap-4">
                ...
                <span className="flex flex-col gap-2">
                  <h1 className="text-white/80 text-sm">
                    ¡Le enviaremos una confirmación de envío cuando sus mangas
                    estén en camino! Apreciamos su compra y esperamos que
                    disfrute de sus manga.
                  </h1>
                  <h1 className="text-white/80 text-sm">
